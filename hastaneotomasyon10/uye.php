...
<body>
    ...
    <div class="table">
        ...
        <form action="islem.php" method="post">
            <div class="user" >
                <input type="text" name="kullanici_adsoyad" placeholder="Adınızı ve Soyadınızı Giriniz">
            </div>
            <div class="user" >
                <input type="text" name="kullanici_tc" placeholder="TC Kimlik Numarınızı Giriniz">
            </div>
            <div class="pass">
                <input type="password" name="kullanici_sifre" placeholder="Şifrenizi Giriniz">
            </div>
